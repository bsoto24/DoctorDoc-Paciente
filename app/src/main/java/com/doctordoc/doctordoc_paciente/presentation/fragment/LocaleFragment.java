package com.doctordoc.doctordoc_paciente.presentation.fragment;
...
import com.doctordoc.doctordoc_paciente.core.BaseFragment;
import com.doctordoc.doctordoc_paciente.data.entity.Locale;
import com.doctordoc.doctordoc_paciente.presentation.presenter.LocalePresenter;
import com.doctordoc.doctordoc_paciente.services.GPS_Service;
...
public class LocaleFragment extends BaseFragment implements OnMapReadyCallback, LocationListener, ClusterManager.OnClusterClickListener<Locale>, ClusterManager.OnClusterItemClickListener<Locale> {
    ...
    private ClusterManager<Locale> mClusterManager;
    ...
    public void mostrar(final Locale locale) {
        ...
        TextView titulo = (TextView) customDialog.findViewById(R.id.nombre_textView);
        TextView direccion = (TextView) customDialog.findViewById(R.id.direccion_textView);
